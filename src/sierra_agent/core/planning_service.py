...
class PlanningService:
    ...
    def generate_plan(self, user_input: str, session_id: Optional[str] = None, available_data: Optional[Dict[str, Any]] = None) -> MultiTurnPlan:
    ...
    def suggest_steps_with_llm(self, user_input: str, available_data: Dict[str, Any], conversation_context=None) -> List[str]:
        ...
        try:
            ...
            return self.llm_service.generate_planning_suggestions(
    ...
    def update_plan_with_llm_service(self, plan: MultiTurnPlan, execution_results: List[ToolResult]) -> List[PlanStep]:
        ...
        try:
            ...
            return self.llm_service.update_plan_suggestions(
